...
st.markdown('<h3 style="color:white;background-image: linear-gradient(to right, red , green);border-radius:20px;padding: 2%;text-align:center"> Web Application for Compound Toxicity Prediction </h3>',unsafe_allow_html=True)
